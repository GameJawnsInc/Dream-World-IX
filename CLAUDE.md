...
- Path D, a genuinely new 3rd overworld world — ★★ rungs 0-5a; V-SHORE: ring trap KILLED ★; THE RENDER GATE built+calibrated (reproduces playtests 4-6 offline) and the corner rebuilt as a VERBATIM SEGMENT TRANSPLANT, all 8 gates green, deployed (playtest pending) → `studies/path-d-new-world/RENDER-GATE.md` + `SEGMENT-TRANSPLANT-PREDICTION.md`; read `GROUND-JUNCTION-SYNTHESIS.md` before wall/ground work
