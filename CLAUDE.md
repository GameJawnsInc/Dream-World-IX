...
- Path D, a genuinely new 3rd overworld world — ★★ rungs 0-5a; V-SHORE ARC: the ring trap KILLED (the sea cut, playtest-confirmed) + THE SHORE FAIRING deployed (138° chord, THE QUANTIZED-FAN LAW: slide needs |hold−tangent| ≤ 67.5°), hug gates 0-stall, PLAYTEST PENDING → `studies/path-d-new-world/VSHORE-SEAL-PREDICTION.md` (tail); read `GROUND-JUNCTION-SYNTHESIS.md` before wall/ground work
