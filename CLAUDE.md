...
- Path D, a genuinely new 3rd overworld world — ★★ rungs 0-5a; V-SHORE ARC CLOSED. The V-corner walk trap REPRODUCED+DECODED offline: the KEEL-stamped Sea4 tri under land poisons the walk ring (cold probes blind to it); unique on the bench; NEXT = the sea-cut fix round → `studies/path-d-new-world/VSHORE-SEAL-PREDICTION.md` (tail); read `GROUND-JUNCTION-SYNTHESIS.md` before wall/ground work
