...
(13,9) headland vs ref (9,9), donor (7,17)'s NE cliff — land round 1, water round 2. 5 golden tests
(`test_coastmorph.py`, data-gated) pin the proven build's hash → [[project-ff9-overworld-coast-mosaic]].
