...
**Frontier:** beach-mint rung 3 (the virgin-shore mint) ★ IN-GAME PROVEN on the real (9,17) (`virgin_mint`/`--virgin-mint`; walkable/animated/capped; the column-scale read: pick ~3-4u-column windows) → [[project-ff9-overworld-coast-mosaic]]; declarative `[[platform]]`; the story-event director (#13) — authoring side proven → [[project-ff9-fork-fidelity-worklist]].
