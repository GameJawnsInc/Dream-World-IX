...
verbatim width), strain ([0.75,1.33] per edge). Rung 2 (structural beach = re-derive the ladder) = the
re-Wang build trigger, designed not built. 13 golden tests pin the proven builds
