...
- Path D, a genuinely new 3rd overworld world — ★★ rungs 0-5a; V-SHORE: rocky cove CHOSEN; THE V-CARRY deployed (the corner = ONE stock window, kinks 1.3/2.4, all gates green, playtest 10 pending); close-range render gate + ATLAS MAP + TONE LAW shipped → `studies/path-d-new-world/SEGMENT-TRANSPLANT-PREDICTION.md` + `ATLAS-MAP.md`; read `GROUND-JUNCTION-SYNTHESIS.md` before wall/ground work
