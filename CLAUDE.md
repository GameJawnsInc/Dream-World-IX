...
- Interactive docs base (docsite/) — site+CLI-ref+shot pipeline+tutorial system BUILT, gates green; curriculum ratified, spine S1-S7 DRAFTED (playtest pending) → `studies/interactive-docs/PLAN.md` + `CURRICULUM.md`
