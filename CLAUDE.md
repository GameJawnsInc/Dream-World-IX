...
- The scene ladder — RUNG 1 COMPLETE ★ (quay ship · rig camera · tracked sail · phases+fades; s66/s68, six laws); next = rung 2 the ferry-scene diegesis (owner design) → `studies/overworld-topography/scene-ladder/`
