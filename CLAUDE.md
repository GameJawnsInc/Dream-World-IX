...
- **Versions:** kit `1.0.0b15`, Blender add-on `0.9.24`. **Provenance gate CLEARED at HEAD** — zero Square-Enix bytes; templates regenerate from the user's own install (`ff9mapkit extract-templates`). → [[project-release-readiness]].
