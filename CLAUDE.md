...
- The scene ladder — ★ rungs 0-3 owner-confirmed; 3c origin-port departures BUILT+DEPLOYED (hall origin-cache + world classifier), playtest pending → `studies/overworld-topography/scene-ladder/`
