...
beyond-shore zip water = TRANSLATE-CLONES, signed ledger. 7 golden tests (`test_coastmorph.py`, data-gated)
pin both proven builds' hashes → [[project-ff9-overworld-coast-mosaic]].
