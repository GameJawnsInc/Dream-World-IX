...
+2.5; deployed --in-place at (18,15) +2.5, AWAITING PLAYTEST. Path A (the full sand edge-table)
stays the beach-mint prerequisite, later. 24 golden tests → [[project-ff9-overworld-coast-mosaic]].
