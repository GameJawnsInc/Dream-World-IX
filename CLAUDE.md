...
the pure-sea4 pair 692+696. Next = cliff-face transition study (user checklist item); scale up with a real
modelled building (the watchtower is a hand-authored primitive).
