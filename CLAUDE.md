...
- Path D, a genuinely new 3rd overworld world — ★★ rungs 0-5a; V-SHORE walk SOLVED; look = THE PRESENTATION FORK (the concave inlet shows stock-lawful rock the island never shows) awaiting owner; render gate CLOSE-RANGE + ATLAS MAP shipped → `studies/path-d-new-world/SEGMENT-TRANSPLANT-PREDICTION.md` + `ATLAS-MAP.md`; read `GROUND-JUNCTION-SYNTHESIS.md` before wall/ground work
