...
- Path D, a genuinely new 3rd overworld world — ★★ rungs 0-5a; walkability + camera owner-confirmed (underlay/C-slice/camera order); CURTAIN GRAMMAR decoded (stock's pinned-strip seal, hover-over-ground = 0 stock instances) and THE CURTAIN SEAL deployed gates-green (24 tris, 4 chains) — awaiting playtest → `studies/path-d-new-world/VSHORE-SEAL-PREDICTION.md` + `CURTAIN-GRAMMAR.md`; read `GROUND-JUNCTION-SYNTHESIS.md` before wall/ground work
