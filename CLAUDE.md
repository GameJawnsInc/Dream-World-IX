...
**AWAITING PLAYTEST.** Reach 4003. Now: Vivi starts at the cyan HOME (left), control locks, ~1s beat, he **walks in** to the magenta spot **and reaches it**, **faces you**, **plays a talk-gesture emote**, says "...hi.", then **instantly warps back to the cyan home** (teleport), control returns; leave + re-enter → he just stands at home (plays once). Flag if: the walk doesn't reach the magenta spot / the emote glitches or hangs (bad anim id) / the teleport-home lands at the wrong spot (Z).
