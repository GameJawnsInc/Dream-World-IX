...
**AWAITING PLAYTEST.** Reach 4003 (New Game → Alexandria → hut → interior door → CUTSCENE2). Look for: (1) on entry, **control LOCKS** and Vivi **walks** forward (legs moving, to the green cross); (2) he **turns to face you**; (3) a text box "...hi."; (4) he **walks back** to his spot and **control returns**; (5) talk to him → "Oh! You're finally here…"; (6) leave via the cyan back door + **re-enter → he just stands at rest** (plays once). Failure modes to note: control doesn't lock / Vivi slides or T-poses instead of walking / wrong destination / doesn't face you / no text / replays on re-entry / freeze. If the core works, **animation + teleport walk-in** are the quick follow-ups (teleport carries the documented Z-negation; animation needs a chosen Vivi anim id).
