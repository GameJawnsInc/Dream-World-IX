...
- Click authoring — ★ Rungs 0-1 + 3 owner-confirmed (the Place tab); Rung 2 cut-out contacts BUILT awaiting the occlusion playtest; open: 4/6 → `studies/click-authoring/PLAN.md`
