...
- The Southern Ring (the composed world) — R1-R4 CONFIRMED; R5c boarding UX confirmed (plate + shore landings); R5d coast-nav seal deployed (boat blocked at kit cliffs; playtest pending) → `studies/overworld-topography/southern-ring/DESIGN.md`
