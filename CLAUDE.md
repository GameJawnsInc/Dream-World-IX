...
- Path D, a genuinely new 3rd overworld world — ★★ rungs 0-5a; the V-SHORE ARC CLOSED owner-confirmed ("no seam mountain all the way around"): underlay + camera order + CURTAIN GRAMMAR + THE TUCK/cliff re-skin. OPEN: the V-corner WALK TRAP at (376,−509) — stuck-only-turn, reproduce with walk_sim first → `studies/path-d-new-world/VSHORE-SEAL-PREDICTION.md` (tail) + `CURTAIN-GRAMMAR.md`; read `GROUND-JUNCTION-SYNTHESIS.md` before wall/ground work
