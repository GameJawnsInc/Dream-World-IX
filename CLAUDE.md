...
**Frontier:** beach-mint rung 3 ★ IN-GAME PROVEN on (9,17) + the REAL-SCALE continent mint BUILT+DEPLOYED on island B (`bank_lower` + `virgin_mint` v2 `pre=`/`pins_from=`/ladder-synthesis; cell (0,16), world ~(34,-1040); PLAYTEST PENDING) → [[project-ff9-overworld-coast-mosaic]]; declarative `[[platform]]`; the story-event director (#13) — authoring side proven → [[project-ff9-fork-fidelity-worklist]].
