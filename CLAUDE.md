...
**Status:** `memoria-patches/upstream/` = ONE submission (FieldCreatorScene fix) + UPSTREAM.md. **Still NOT opened** — awaiting the user's GitHub fork + go-ahead. Next: user forks `Albeoris/Memoria`, applies the patch, opens the PR with the provided text.
