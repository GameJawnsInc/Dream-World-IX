...
≥2 clean lines**, top (5,2)×12); next = multi-column growth on a sweep donor / band-crossing re-Wang / multi-cell
carry; scale to a real CONTINENT (towns+entrances via `world-entrance --building`).
