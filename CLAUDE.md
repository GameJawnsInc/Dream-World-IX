...
**AWAITING PLAYTEST 2.** Reach 4003 (New Game → Alexandria → hut → interior door → CUTSCENE2). Now: on entry control locks, **~1s beat (Vivi stands at his magenta spot)**, then Vivi **walks** to the green cross (no circle), **turns to face you**, says "...hi.", **walks back**, control returns. Then: talk → "Oh! You're finally here…"; leave + **re-enter → he just stands** (plays once). If he STILL circles, the warm-up is too short for this entry — bump `[cutscene] warmup` (I can rebuild instantly). If the core works, **animation + teleport walk-in** are the quick follow-ups.
