...
- Interactive docs base (docsite/) — rungs 0+1a+2 BUILT, gates green: nav+search site, generated CLI reference, gui_snap shot pipeline w/ anchored callouts; next = block data layer + executed tutorials → `studies/interactive-docs/PLAN.md`
