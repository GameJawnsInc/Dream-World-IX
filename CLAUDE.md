...
field is SHAPE DATA read from the donor; step 2 = displace the chains + TRANSPORT the field (avoid
the 4 non-table configs). 13 golden tests pin the proven builds → [[project-ff9-overworld-coast-mosaic]].
