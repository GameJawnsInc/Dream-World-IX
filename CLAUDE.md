...
beach: 4 true noses; beach-reshape = exactly 1 lawful window map-wide, (7,17)). Open: a cliff
shape-class analog (curvature un-gated). 19 golden tests → [[project-ff9-overworld-coast-mosaic]].
