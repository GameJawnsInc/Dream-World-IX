...
- Click authoring — ★ Rungs 0-1 + 3 owner-confirmed (the Place tab); Rung 2 cut-out contacts ★ in-game, s35 engine cache retired; open: 4/6 → `studies/click-authoring/PLAN.md`
