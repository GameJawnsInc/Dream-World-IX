...
- Path D, a genuinely new 3rd overworld world — ★★ rungs 0-5a; V-SHORE: rocky cove CHOSEN; THE TUCK REBUILD deployed (corner wall = the island's OWN measured vocabulary; 332 authored tris → 14; playtest 11 pending) — THE OVERHANG-CONTEXT LAW: stock's overhanging lip is unusable over a cut sea; new gates = TEXEL-DENSITY + PEER → `studies/path-d-new-world/SEGMENT-TRANSPLANT-PREDICTION.md` + `ATLAS-MAP.md`; read `GROUND-JUNCTION-SYNTHESIS.md` before wall/ground work
