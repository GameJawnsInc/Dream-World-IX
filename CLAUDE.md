...
(10,17)+2×2 at cols 0-1 rows 7-11, shared border z=-640 (32 rows certified). Next = band-crossing re-Wang /
cliff-face transition study (user checklist item); scale up with a real modelled building (the watchtower is a
