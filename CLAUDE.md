...
- In-game 100%-completion Journal — ★ rung 0 owner-confirmed on bench 30800 (DLL-free reads work; `Null.SBit[5]` reads TH points) and T1 `journal report` BUILT; catalog prose is the dominant cost → `studies/completion-journal/PLAN.md`
