...
- The scene ladder — rungs 0/1a/1b ★ (quay ship · rig camera · the tracked sail; s66/s68 + the CARROT/RIG-RADIUS laws); next = 1c handshake+fade → `studies/overworld-topography/scene-ladder/`
