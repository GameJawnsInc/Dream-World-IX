...
- Path D, a genuinely new 3rd overworld world — ★★ rungs 0-5a; V-SHORE ARC CLOSED. The V-corner ring trap DECODED (KEEL-stamped sea under land poisons the walk cache) + THE SEA CUT deployed per-class, all gates green, PLAYTEST PENDING (P-H) → `studies/path-d-new-world/VSHORE-SEAL-PREDICTION.md` (tail); read `GROUND-JUNCTION-SYNTHESIS.md` before wall/ground work
