...
- Path D, a genuinely new 3rd overworld world — ★★ rungs 0-5a; V-SHORE: ring trap KILLED ★; the fairing PARKED at the tuck baseline (mechanics proven, 3 look rounds failed — no gate renders); NEXT = the render-gate / segment-transplant study angles → `studies/path-d-new-world/VSHORE-SEAL-PREDICTION.md` (tail); read `GROUND-JUNCTION-SYNTHESIS.md` before wall/ground work
