...
slider (bent runs + thin sea slivers; the fold precheck is the envelope measure). 11 golden tests
(`test_coastmorph.py`, data-gated) pin the proven builds → [[project-ff9-overworld-coast-mosaic]].
