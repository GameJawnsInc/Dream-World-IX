...
- Path D, a genuinely new 3rd overworld world — rungs 0-2 BUILT + DEPLOYED (s70/s71/s72, 9013 registered), in-game UNPROVEN; Rung 1 (a runtime-built WorldDisc) is still the pivotal unknown → `studies/path-d-new-world/PLAN.md`
