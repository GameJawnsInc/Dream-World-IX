...
clean line, same-tweak-set A/B, "don't see any artifacts"); next = the first in-game MULTI-cut on a sweep donor /
band-crossing re-Wang / multi-cell carry; scale to a real CONTINENT (towns+entrances via `world-entrance --building`).
