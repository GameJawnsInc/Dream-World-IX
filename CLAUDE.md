...
- Path D, a genuinely new 3rd overworld world — ★★ rungs 0-5a proven; wall synth: strip-carry PLUMBING STOP, then JUNCTION GRAMMAR DECODED (crest/corner/foot laws; junction-aware round registrable) → `studies/path-d-new-world/JUNCTION-GRAMMAR.md`
