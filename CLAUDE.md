...
game-gated test. Next = scale up with a real modelled building (the watchtower is a hand-authored primitive);
the content act: a multi-island fused region with entrances.
