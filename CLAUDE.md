...
the SLACK law: growth needs water slack on the shifted frame side); next = growth loops at scale / band-crossing
re-Wang / multi-cell carry / cliff-face transition study (user checklist item); scale to a real CONTINENT
