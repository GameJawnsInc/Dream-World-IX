...
(qualifying donors: (21,10)/(16,17)★/(13,18)/(8,16)/(7,15)); next = z-axis RowInsert (the other growth axis) /
band-crossing re-Wang / multi-cell carry / cliff-face transition study (user checklist item); scale to a real
