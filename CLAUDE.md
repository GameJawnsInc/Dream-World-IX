...
before BEACH-MINT. **Path B RESOLVED by falsification (2026-07-10):** the sand band is a single-row
...
(7,17) ladder: −1/−1.5 + −3..−5.5 build (−2..−2.5 = the lawful width-envelope valley); deployed at
(16,8) vs (13,8) identity / (14,8) drag, AWAITING PLAYTEST. Path A (the full sand edge-table) stays
the beach-mint prerequisite, later. 23 golden tests → [[project-ff9-overworld-coast-mosaic]].
