...
| **`[deathrules]`** — declarative game-over rules (once-per-battle second-wind revive — full Phoenix or short no-summon + `revive_hp`, chance, Eiko auto-revive removal, flag-gateable) | ✓ | [SCRIPTS_DLL](SCRIPTS_DLL.md) |
