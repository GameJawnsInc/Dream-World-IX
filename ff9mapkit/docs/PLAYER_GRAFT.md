...
| **P4 — the ONE in-game gate (PROVEN)** | `import fbg_n08_udft_map122_uf_sto_0 --graft-player-funcs` → build → deploy → ~ → Warp | full suite + new, all green | — | **the cask turns to face you on EXAMINE (tag-24 fires) and the boxes push/examine (tags 11/12 fire)** — confirmed in-game. |
