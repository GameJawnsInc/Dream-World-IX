...
VOCAB = {
    ...
    'cutscene.steps': ('actor', 'anim', 'animation', 'face_player', 'flag', 'options', 'path', 'requires_flag', 'requires_flag_clear', 'say', 'set_flag', 'set_flags', 'speaker', 'speed', 'steps', 'tail', 'teleport', 'turn', 'wait', 'walk', 'with_prev'),
    'dialogue': ('wrap',),
