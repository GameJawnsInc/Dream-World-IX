...
def test_world_role_from_clip_vocabulary():
    assert C.world_role("GEO_SUB_W0_001") == "chocobo"     # _CHO fly/dive/feed clips
    assert C.world_role("GEO_SUB_W0_008") == "vehicle"     # takeoff/fly -> airship / ship
    assert C.world_role("GEO_SUB_W0_002") == "walker"      # run/stand/idle -> a party-leader overworld chibi
