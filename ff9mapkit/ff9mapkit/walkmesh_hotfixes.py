...
_HOTFIXES = {
    ...
    2356: Hotfix(2356, "Gulug/Room (Red Dragon through the wall)", "load_time",
                 "At field load the engine deactivates the broken-wall triangles so the player can't walk "
                 "through the gap the Red Dragon burst open. Unconditional -- reproduced by deactivating the "
                 "same tris at load.",
