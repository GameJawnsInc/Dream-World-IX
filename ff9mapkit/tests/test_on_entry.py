...
def test_absent_on_entry_adds_exactly_one_entry(tmp_path):
    ...
    _b, _n, _e, _c, _ch, oe, _, _, _gw9, _co10, _sp11, _bh12, _ni13 = collect_text(proj2)
...
def test_on_entry_message_text_shares_the_mes_block(tmp_path):
    ...
    body, _n, _e, _c, _ch, oe, _, _, _gw9, _co10, _sp11, _bh12, _ni13 = collect_text(FieldProject.load(p))
