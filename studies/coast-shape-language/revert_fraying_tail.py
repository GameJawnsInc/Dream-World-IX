"""Revert THE FRAYING TAIL rung A (the comma anchor at Disc9 cells (10,12)+2x3).
...
CELLS = [(11, 12), (10, 13), (11, 13), (10, 14), (11, 14)]
PARTS = ("Terrain.ff9mesh", "Sea4.ff9mesh", "Donor.txt")
    ...
    for bx, by in CELLS:
        for part in PARTS:
            ...
            if p.exists():
                todo.append(p)
    if not todo:
        print("nothing to revert -- the anchor is not deployed")
        return 0
    for p in todo:
