...
**Encounter AREA bits.** Encounters gate on **topograph 36-38** (`ff9.cs:4255`); the table is picked by `zone = w_worldAreaZone[m_GetIDArea(...)]` (`ff9.cs:4263`, `:9237`, table at `:1348`). Cross-tab of the carry's land:
