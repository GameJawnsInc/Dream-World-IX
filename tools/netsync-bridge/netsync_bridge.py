...
Pure stdlib, no dependencies. Usage:
    ...
    py netsync_bridge.py                 # listen on ws://127.0.0.1:49201
    py netsync_bridge.py --port 49300    # different local port
    py netsync_bridge.py --relay ws://192.168.1.50:7777   # different relay
